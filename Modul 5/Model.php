    ...
    if (!empty($result)) {
        if ($nama_tabel == "member") {
            foreach ($result as $hasil) {
                ...
                echo "<td>";
                echo "<a class='btn btn-primary' href='tambah-member.php?id_member=" . $hasil['id_member'] . "'>Edit</a>";
                echo " ";
                echo "<a class='btn btn-danger' href='data-member.php?id_member=" . $hasil['id_member'] . "' onclick=\"return confirm('Yakin Ingin Dihapus?')\">Hapus</a>";
                echo "</td>";
                echo "</tr>";
            }
            ...
            foreach ($result as $hasil) {
                ...
                echo "<td>";
                echo "<a class='btn btn-primary' href='tambah-buku.php?id_buku=" . $hasil['id_buku'] . "'>Edit</a>";
                echo "  ";
                echo "<a class='btn btn-danger' href='daftar-buku.php?id_buku=" . $hasil['id_buku'] . "' onclick=\"return confirm('Yakin Ingin Dihapus?')\">Hapus</a>";
                echo "</td>";
                echo "</tr>";
            }
            ...
            foreach ($result as $hasil) {
                ...
                echo "<td>";
                echo "<a class='btn btn-primary' href='tambah-peminjaman.php?id_peminjaman=" . $hasil['id_peminjaman'] . "'>Edit</a>";
                echo " ";
                echo "<a class='btn btn-danger' href='data-peminjaman.php?id_peminjaman=" . $hasil['id_peminjaman'] . "' onclick=\"return confirm('Yakin Ingin Dihapus?')\">Hapus</a>";
                echo "</td>";
                echo "</tr>";
            }
        }
